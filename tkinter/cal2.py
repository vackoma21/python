...
valLabel = Label(root,
               width=36, borderwidth=3, font=21,
               bg=bgColor, fg=fgColor,
               relief="solid")
screen = Entry(root,
               width=36, borderwidth=5, font=28,
               bg=bgColor, fg="#E0E0E0",
               relief="solid", insertbackground='white')
screen.bind('<Key>', keyNumber)

plusBttn = Button(root,
                  text="+", pady=20, padx=29, font=21,
                  relief="solid", borderwidth=3, bg=bgColor, fg=fgColor,
                  activebackground=bgColor, activeforeground=fgColor, highlightcolor=bgColor,
